describe(`TC-PBI3-ADD-TASK-BASIC-3\n 
  ...
  it('should have save button ', () => {
    ...
    cy.get('.itbkk-titleza').type("DevSecOps1DevSecOps2DevSecOps3DevSecOps4DevSecOps5DevSecOps6DevSecOps7DevSecOps8DevSecOps9DevSecOps0")
    ...
    cy.get('.itbkk-assigneesza').type("Assignees1Assignees2Assignees3")
